...
#                  max_aa_types: int = 22,
#                  max_relpos: int = 32,
#                  name: str = "residue_pair_encoder"):
#         super().__init__(name=name)
#         self.max_num_atoms = max_num_atoms
#         self.max_aa_types = max_aa_types
#         self.max_relpos = max_relpos
#         self.aa_pair_embed = hk.Embed(vocab_size=self.max_aa_types*self.max_aa_types, embed_dim=feat_dim)
#         self.relpos_embed = hk.Embed(vocab_size=2*max_relpos+1, embed_dim=feat_dim)

#         self.aapair_to_distcoef = hk.Embed(
#             vocab_size=self.max_aa_types*self.max_aa_types,
#             embed_dim=max_num_atoms*max_num_atoms,
#             w_init=hk.initializers.Constant(0.0)
#         )
#         self.distance_embed = hk.Sequential([
...
#         # # All
#         # feat_all = jnp.concatenate([feat_aapair, feat_relpos, feat_dist], axis=-1)
#         # feat_all = self.out_mlp(feat_all)   # (N, L, L, F)
#         # feat_all = feat_all * mask_pair[:, :, :, None]
#         return feat_all
